...
# get protein data for CRC
# 20160703 jmd

pdat_CRC <- function(dataset=NULL, basis="AA") {
  # list available datasets
  if(is.null(dataset)) { 
    return(c("WTK+08", "AKP+10_CRC", "AKP+10_CIN", "AKP+10_MIN", "JKMF10",
             "XZC+10_I", "XZC+10_II", "ZYS+10", "BPV+11_adenoma",
             "BPV+11_stage.I", "BPV+11_stage.II", "BPV+11_stage.III",
             "BPV+11_stage.IV", "JCF+11", "MRK+11_AD.NC", "MRK+11_AC.AD",
             "MRK+11_AC.NC", "KKL+12", "KYK+12", "WOD+12", "YLZ+12", "MCZ+13",
             "KWA+14", "UNS+14", "WKP+14", "STK+15", "WDO+15_A.N",
             "WDO+15_C.A", "WDO+15_C.N", "LPL+16_ACP", "LPL+16_CIS",
             "LPL+16_ICC", "PHL+16_AD", "PHL+16_CIS", "PHL+16_ICC"))
  }
  # get study and stage/condition
  study <- strsplit(dataset, "_")[[1]][1]
  stage <- strsplit(dataset, "_")[[1]][2]
  extdatadir <- paste0(system.file("extdata", package="canprot"), "/")
  if(study=="JKMF10") {
    ...
    dat <- read.csv(paste0(extdatadir, "JKMF10.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "KWA+14.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "STK+15.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "UNS+14.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "BPV+11.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "WDO+15.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "WOD+12.csv"), as.is=TRUE)
    description <- "T / N"
    print(paste0("pdat.CRC: ", description, " [", dataset, "]"))
    ...
    dat <- read.csv(paste0(extdatadir, "JCF+11.csv"), as.is=TRUE)
    description <- "T / N"
    print(paste0("pdat.CRC: ", description, " [", dataset, "]"))
    ...
    # XZC+10_I, XZC+10_II
    dat <- read.csv(paste0(extdatadir, "XZC+10.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "AKP+10.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "KKL+12.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "WKP+14.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "KYK+12.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "ZYS+10.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "MRK+11.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "YLZ+12.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "WTK+08.csv"), as.is=TRUE)
    description <- "T / N"
    print(paste0("pdat.CRC: ", description, " [", dataset, "]"))
    # list known UniProt IDs
    ...
    dat <- read.csv(paste0(extdatadir, "PHL+16.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "LPL+16.csv"), as.is=TRUE)
    ...
    dat <- read.csv(paste0(extdatadir, "MCZ+13.csv"), as.is=TRUE)
