...
diffplot(comptab3, c("pI", "GRAVY"))
diffplot(comptab4, c("nAA", "MW"))
```
...
__s__. __t__. Supplementary Table 2 of @GAM+16, filtered to include proteins with fold change > 2 or < 0.5 in hypertonic saline (HTS) / isotonic solution, with or without cytomix treatment (Cmx).
