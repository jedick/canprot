...
This vignette from the R package [canprot](https://github.com/jedick/canprot) version `r packageDescription("canprot")$Version` shows compositional metrics and phylostrata for secreted proteins that are differentially expressed in hypoxia compared to control conditions.
