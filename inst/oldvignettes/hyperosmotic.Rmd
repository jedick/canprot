...
pdat <- lapply_canprot(datasets, pdat_osmotic, basis = "QEC")
datasets2 <- pdat_osmotic2()
pdat2 <- lapply_canprot(datasets2, pdat_osmotic2, basis = "QEC")
```
...
comptab <- lapply_canprot(pdat, get_comptab, plot.it = FALSE, mfun = "mean", oldstyle = TRUE)
```
