...
```{r datasets}
datasets <- pdat_halophiles(2020)
```

```{r comptab, results="hide", message=FALSE, echo = FALSE}
pdat1 <- lapply_canprot(datasets, pdat_halophiles)
...
write.csv(out, "halophiles.csv", row.names = FALSE, quote = 2)
```
...
__g__. Supplementary Table 1 of @KSK+18 (amino acid compositions computed from protein sequences in the list of gene annotations).
__h__. __i__. Supporting Table 1C of @JSP+19. Only proteins with at least 2-fold expression difference and marked as significant were included.
