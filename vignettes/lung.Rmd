...
__l__. __m__. Gene names from Table S1 (genes) and UniProt names from Table S2 (proteins) of @BLL+16, filtered to include genes or proteins with log~2~ fold change > 1.5 or < -1/1.5 and _p_-value < 0.05.
__n__. Gene names from Table S2 of @FGP+16.
__o__. Gene names from Table 1 of @JCP+16.
__p__. __q__. __r__. Supplemental Table S3B of @HHH+16 (primary tumor / normal comparison; pN0: no nodes involved; pN1: ipsilateral peribronchial/interlobar/hilar LN metastasis; pN2: ipsilateral mediastinal LN metastasis; M1: distant metastasis or malignant effusion).
__s__. Supplemental Table 2 of @TLB+16, filtered with adjusted _p_-value < 0.05 and fold change ≥ 1.5 or ≤ 2/3.
__t__. Gene names from Supplementary Table S1 of @FGW+17, filtered with _p_-value < 0.05.
__u__. Table 1 of @LZW+17.
__v__. Supplementary Table S2 of @SFS+17 (sheet LF: label-free quantification).
__w__. Supplementary Table 1 of @WLC+17.
__x__. __y__. __z__. __A__. __B__. __C__. Gene names from Tables S2--S6 of @YCC+17 filtered to keep proteins with fold change ≥1.5 or ≤2/3 (Oncogene: oncogene-coded proteins; TSG: tumor suppressor gene-coded proteins; Glycoprotein: glycoproteomics data).
__D__. Gene names from Supplementary Table S2 of @NLW+18.
