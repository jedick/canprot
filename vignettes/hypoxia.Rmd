...
<b>a</b>. Gene IDs from Supplementary Table S4 @BKS+09.
<b>b</b>. Supplemental Table 2A of @FWH+13 (control virus cells).
<b>c</b>. <b>d</b>. Supplemental Table S1 of @RHD+13, filtered to include proteins with iTRAQ ratios < 0.83 or > 1.2 and _p_-value < 0.05.
<b>e</b>. Supporting Information table of @VTMF13, filtered to include proteins with a normalized expression ratio of > 1.2 or < 0.83.
<b>f</b>. Supporting Information Table S1 @DCH+14.
<b>g</b>. <b>h</b>. <b>i</b>. <b>j</b>. Supplemental Table S1 of @DYL+14, filtered to include proteins with _p_-value < 0.05 (-S: supernatant fraction; -P: pellet fraction).
<b>k</b>. Gene names from Supporting Information Table S10 of @OHS+14.
<b>l</b>. Supplementary Table S1 of @BSA+15.
<b>m</b>. Supplemental Information Table S1 of @HWA+16, filtered to include proteins with a fold change of < 0.5 or > 1 and that were detected in only hypoxic or only normoxic conditions.
<b>n</b>. <b>o</b>. Gene names from @LCS16 (data files provided by Ming-Chih Lai).
<b>p</b>. Extracted from Table S2E (whole cell lysate) of @CGH+17, keeping proteins with FDR < 0.05.
<b>q</b>. Supplemental Table S4 of @ZXS+17.
<b>r</b>. Supplementary Tables S6-S7 (proteome) of @CLY+18.
<b>s</b>. List of up- and down-regulated proteins from @GBH+18 (provided by Alex Greenhough), filtered to include proteins with average fold change ≥ 1.5 or ≤ 2/3.
<b>t</b>. Gene names from Figure 1F of @LKK+18.
<b>u</b>. Supplemental file 1 of @WTG+18 (provided by Gordana Vunjak-Novakovic), filtered to include proteins with Normalized Ratio [Hypoxia MSC/Control MSC] ≥ 1.5 or ≤ 2/3 and _p_-value < 0.05.
<b>v</b>. Gene names from Supplementary file S1 of @CSK+19 for the two replicates labelled as "input_Log2ratioHL_firstIP" and "input_Log2ratioLH_secondIP" (soluble extracts before immunoprecipitation), filtered to include proteins where Log2ratio is > 0.2 or < -0.2 for both replicates.
<b>w</b>. Proteins identified as up- or down-regulated > 1 SD in Data File S1 of @KAN+19 (sheet "Proteome").
