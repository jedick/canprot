...
__v__. Additional file 1: Table S1 of @LLL+19.
__w__. Gene names from Supplementary Information Tables S6 and S7 of @BCMS20.
__x__. __y__. __z__. __A__. __B__. __C__. Supplementary Table 1A of @RVN+20, filtered to include proteins with median fold change between normoxic and hypoxic conditions in any individual treatment > 1.5 or < 2/3. DMSO: dimethyl sulfoxide, NO.sul: NO-Sulindac, sul: Sulindac, 4Gy: radiation.
__D__. __E__. Supplementary Tables S3b (sheet "HPNP") and S3c (sheet "HHNH") of @SPJ+20 for POS (primay origin) and HMPOS (metastatic origin) canine osteosarcoma (OS) cells.
