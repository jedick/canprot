...
__a__. Gene IDs from Supplementary Table S4 of @BKS+09.
...
__k__. Gene names from Supporting Information Table S10 of @OHS+14.
__l__. Supplementary Table S1 of @BSA+15.
__m__. Supplemental Information Table S1 of @HWA+16, filtered to include proteins with a fold change of < 0.5 or > 1 and that were detected in only hypoxic or only normoxic conditions.
__n__. __o__. Gene names from @LCS16 (data files provided by Ming-Chih Lai).
__p__. Extracted from Table S2E (whole cell lysate) of @CGH+17, keeping proteins with FDR < 0.05.
__q__. Supplemental Table S4 of @ZXS+17.
__r__. Supplementary Tables S6-S7 (proteome) of @CLY+18.
__s__. List of up- and down-regulated proteins from @GBH+18 (provided by Alex Greenhough), filtered to include proteins with average fold change ≥ 1.5 or ≤ 2/3.
__t__. Gene names from Figure 1F of @LKK+18.
__u__. Supplemental file 1 of @WTG+18 (provided by Gordana Vunjak-Novakovic), filtered to include proteins with Normalized Ratio [Hypoxia MSC/Control MSC] ≥ 1.5 or ≤ 2/3 and _p_-value < 0.05.
__v__. Gene names from Supplementary file S1 of @CSK+19 for the two replicates labelled as "input_Log2ratioHL_firstIP" and "input_Log2ratioLH_secondIP" (soluble extracts before immunoprecipitation), filtered to include proteins where Log2ratio is > 0.2 or < -0.2 for both replicates.
