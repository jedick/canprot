...
The vignettes can be viewed online at <https://chnosz.net/canprot/vignettes>.
Additional vignettes based on data from the Human Protein Atlas (HPA) and The Cancer Genome Atlas (TCGA) are available in the [JMDplots package on GitHub](https://github.com/jedick/JMDplots) (see also <https://chnosz.net/JMDplots/vignettes>)
