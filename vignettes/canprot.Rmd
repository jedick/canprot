...
Specify the amino acid composition of a protein in a data frame with column names corresponding to the 3-letter abbreviations of the amino acids.
...
## Making other vignettes in the package

There is a vignette for each dataset of differentially expressed proteins.
