...
Previous vignette: [Demo for canprot](demo.html) | Next vignette: [More about metrics](metrics.html)
...
**This analysis shows that proteins become more oxidized around the GOE.**
