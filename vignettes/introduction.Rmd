...
Next vignette: [More about metrics](metrics.html)

## Reading FASTA files

`KHAB17.fasta` was obtained from Supplemental Information of @KHAB17 and is provided in the `extdata` directory of **canprot**.
...
A geochemical biology hypothesis is that the proteins should get more oxidized around the GOE.
...
**This analysis shows that proteins do get more oxidized around the GOE.**
