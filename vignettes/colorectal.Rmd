...
```{r datasets}
datasets <- pdat_CRC(2020)
```

```{r comptab, results="hide", message=FALSE, echo = FALSE}
pdat1 <- lapply_canprot(datasets, pdat_CRC)
...
<b>a</b>. Genes identified as up- or down-expressed in human CRC in Table 4 of @KPF+07.
<b>b</b>. Table 1 and Supplementary Data 1 of @WTK+08 (Swiss-Prot and UniProt accession numbers from Supplementary Data 2).
<b>c</b>. <b>d</b>. IPI accession numbers from Supplemental Table 4 of @XZC+10.
<b>e</b>. IPI accession numbers from Supplemental Table 4 of @ZYS+10.
<b>f</b>. <b>g</b>. <b>h</b>. <b>i</b>. Gene names from supplemental Table 9 of @BPV+11.
<b>j</b>. Supplementary Table 2 of @JCF+11.
<b>k</b>. Table S8 of @MRK+11.
<b>l</b>. Supplementary Table 1 of @SHHS11.
<b>m</b>. Gene names from Supplementary Table 4 of @KYK+12, filtered to include proteins with expression ratio >2 or <0.5 in both mTRAQ and cICAT analyses.
<b>n</b>. Supplementary Table 4 of @WOD+12.
<b>o</b>. Table 2 of @CZD+14.
<b>p</b>. Ensembl protein IDs from Supporting Table 2 of @STK+15.
<b>q</b>. Proteins marked as having a significant change between normal tissue (N) and adenocarcinoma (C) in SI Table 3 of @WDO+15.
<b>r</b>. SI Table S3 of @LXM+16, filtered to include proteins with _p_-value <0.05.
<b>s</b>. <b>t</b>. Gene names from Supplementary Table 4 of @PHL+16, for differential expression between normal colonic mucosa (NC) and carcinoma in situ (CIS) or invasive colorectal cancer (ICC).
<b>u</b>. Table S3 of @CTW+17.
<b>v</b>. Dataset 6A of @HZW+17.
<b>w</b>. Supplementary Material Table S1 of @LLL+17.
<b>x</b>. Table 2 of @NKG+17.
<b>y</b>. Table S2 of @QMB+17, filtered to include comparisons between adenocarcinoma and diverticular disease.
<b>z</b>. Table S1 of @TMS+17, filtered to include proteins that are consistently up- or down-expressed in at least 11 of 12 patients.
<b>A</b>. IPI accession numbers from Table S2 of @ZLY+17.
<b>B</b>. Supplementary Table 1B of @AKG+18, filtered to include proteins with expression ratio > 3/2 or < 2/3.
<b>C</b>. Supplementary Information Table S2 of @WYL+19
