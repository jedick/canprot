...
__n__. Gene names from Supporting Information Tables S1 (normoxic) and S2 (hypoxic) of @RTA+15, filtered to include proteins that were exclusively identified in either condition.
__o__. Gene names from Tables 1 and 2 of @RSE+16.
__p__. __q__. Extracted from Tables S2A (exosomes) and S2B (secretome) of @CGH+17, keeping proteins with FDR < 0.05.
__r__. Supplementary Tables S8-S9 (secretome) of @CLY+18.
__s__. Supplementary Table 1 of @DWW+18.
__t__. Table S2 of @FPR+18.
__u__. Supplementary Material Tables S1 and S2 of @ODS+18, filtered to include proteins exclusively identified in hypoxia or normoxia.
