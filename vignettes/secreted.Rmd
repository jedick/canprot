...
__l__. Gene names from Tables 1 and 2 of @RSE+16.
__m__. __n__. Extracted from Tables S2A (exosomes) and S2B (secretome) of @CGH+17, keeping proteins with FDR < 0.05.
__o__. Supplementary Tables S8-S9 (secretome) of @CLY+18.
__p__. Supplementary Table 1 of @DWW+18.
__q__. Table S2 of @FPR+18.
__r__. Proteins identified as up- or down-regulated > 1 SD in Data File S1 of @KAN+19 (pooled data from sheets "Soluble Secretome" and "EVs").
__s__. __t__. Extracted from proteinGroups.txt in ProteomeXchange Dataset [PXD008104](ftp://ftp.pride.ebi.ac.uk/pride/data/archive/2019/03/PXD008104) [@NJVS19]. Expression ratios between hypoxia and normoxia were calculated from LFQ intensity values, and proteins were classified as up- or down-expressed if they had expression ratios > 1.2 or < 1/1.2 in all three experiments for one cell type (CAM or NTM). The Majority protein IDs and mean values of the expression ratios were saved in the data file.
__u__. Supplementary Table 2 of @PDT+19, filtered with log~2~ fold-change cutoff of 1.
